...
- Current lane: **Coding handoff** (`idea-to-deploy`, `cto-loop`, `deploy-and-monitor`, `code-review`, `verification-gate`, `ultrawork`, `team`, `ultraqa`, `+5 more`) - Codex, Claude Code, Hermes coding, or oh-my runtime paths with observed evidence tracking.
