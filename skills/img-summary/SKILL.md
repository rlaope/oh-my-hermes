...
- Current lane: **Materials and visual summaries** (`design-quality-gate`, `materials-package`, `img-summary`, `report-package`, `deliverable-package`) - premium websites, decks, PDFs, spreadsheets, documents, posters, image summary cards, and shareable packages.
...
Use when Hermes should shape supplied notes, PRs, issues, research/news, reports, or releases into a source-specific visual prompt without claiming image generation.
