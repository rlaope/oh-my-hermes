...
USE_CASES: tuple[UseCase, ...] = (
    ...
    UseCase(
        ...
        primary_skill="memory-sync",
        playbook="memory-sync",
        harness="memory-sync",
        feature_surface="memory-sync skill: candidate cleanup list, conflict detection, and human approval gates.",
        direct_skill_invocation="$memory-sync Inspect stale project memories and ask me what to keep.",
        hermes_chat_prompt="Use OMH memory-sync for: Inspect stale project memories and ask me what to keep.",
        ...
        proof_surfaces=("omh recommend", "omh playbook inspect memory-sync", "omh harness inspect memory-sync"),
