...
PARITY_CAPABILITIES: tuple[ParityCapability, ...] = (
    ParityCapability(
        ...
        evidence=(
            ...
            "src/omh/install/plugin_pack.py",
            "src/omh/install/plugin_observations.py",
    ...
    ParityCapability(
        ...
        evidence=(
            ...
            "src/omh/coding/team_readiness.py",
    ...
    ParityCapability(
        ...
        status="available",
        evidence=("src/omh/coding/isolation.py", "src/omh/coding/worktree_creator.py", "src/omh/commands/worktree.py", "src/omh/wrapper/executor_sessions.py", "tests/test_worktree_creator.py"),
    ...
    ParityCapability(
        ...
        status="available",
        evidence=("src/omh/hud/__init__.py", "src/omh/plugin_bundle/omh/tools/hud_tool.py", "src/omh/wrapper/sessions.py", "src/omh/runtime/artifacts.py"),
    ...
    ParityCapability(
        ...
        status="available",
        evidence=("src/omh/mcp_bridge/__init__.py", "src/omh/commands/mcp.py", "src/omh/probe/__init__.py", "tests/test_mcp_bridge.py"),
    ...
    ParityCapability(
        ...
        status="available",
        evidence=("src/omh/workflows/goal_loop.py", "src/omh/commands/loop.py", "skills/loop/SKILL.md", "skills/ultraprocess/SKILL.md"),
    ...
    ParityCapability(
        ...
        status="available",
        evidence=("src/omh/commands/setup.py", "src/omh/doctor/__init__.py", "src/omh/release/__init__.py", "install.sh"),
