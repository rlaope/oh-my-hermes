...
_SPECIALISTS = (
    SpecialistDefinition(
        ...
        purpose="Turn an uncertain question into bounded source-backed context before planning.",
        ...
        required_context=("research question", "source boundary", "freshness requirement"),
        quality_checks=("source/inference separation", "freshness disclosure", "unknowns retained"),
