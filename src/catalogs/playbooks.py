...
_PLAYBOOKS = (
    ...
    Playbook(
        ...
        summary="Prepare Scout, Analyst, and Briefer research operations with source inbox, briefing status, and optional integration readiness.",
        use_when="A user wants ongoing or recurring market, competitor, paper, news, or source-monitoring research without hand-building Hermes profiles, cron, NotebookLM, Obsidian, and delivery glue.",
        keywords=(
            "research department",
            "research ops",
            "research operations",
        ...
        pipeline=("scope_research", "prepare_source_inbox", "prepare_lanes", "classify_integrations", "briefing_status"),
        ...
        stages=(
            PlaybookStage(
                ...
                "hermes",
                "Name topic, source boundaries, cadence, delivery target, storage preference, and missing confirmations.",
                "research_department_plan/v1",
                ("ask_followup", "show_research_department_plan"),
                ("topic", "source boundaries", "cadence", "delivery", "storage"),
            ...
            PlaybookStage(
                ...
                "Classify optional integrations",
                "wrapper",
                "Record whether NotebookLM, Obsidian, scheduler, and delivery targets are unknown, available, unavailable, or preferred.",
                "research_department_plan/v1",
                ("confirm_cadence_delivery_storage", "show_status"),
                ("operator-supplied integration readiness", "missing setup decisions"),
                "Integration readiness is not NotebookLM execution, Obsidian writes, scheduler enablement, or gateway delivery evidence.",
            ),
            PlaybookStage(
                "briefing_status",
        ...
        acceptance_criteria=(
            "The plan names topic, sources, cadence, delivery target, storage preference, and optional integration readiness.",
            "Scout, Analyst, and Briefer lanes are mapped to concrete OMH skills and source inbox buckets.",
            "Source retrieval, NotebookLM, Obsidian, scheduler, gateway delivery, and verification claims remain not observed until evidence exists.",
        ),
        not_evidence_until_observed=(
            "source_retrieval_observed",
