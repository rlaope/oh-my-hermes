...
_SURFACE_PLAYBOOKS = (
    ...
    _surface_playbook(
        "agent-ops-review",
        "Agent ops review",
        "Explain current coding-agent, runtime, handoff, dispatch, result, verification, review, CI, and merge status from observed records.",
        "Use when the user asks whether Codex, Claude Code, Hermes coding, or another executor session is running and what it is doing now.",
        (
            "agent ops",
            "agent status",
            "executor session",
        ...
        pipeline=("read_runtime_ledger", "summarize_context", "show_status_card", "record_next_observation"),
        first_action="read_runtime_ledger",
        evidence_boundary="Agent status review is not executor dispatch, result, verification, review, CI, merge-readiness, or merge evidence.",
    ),
    _surface_playbook(
        "workflow-learning",
        "Workflow learning",
