...
_RULES = (
    ...
    CoverageRule(
        ...
        "partial",
        "high",
        ("voice-operator", "media-input-operator", "gateway-intent-card", "visual-qa", "toolbelt-readiness"),
        "OMH can prepare voice, media, gateway, and visual evidence cards; platform connectors remain observed external tools.",
        "live_media_gateway",
    ),
    CoverageRule(
        ...
        "partial",
        "high",
        ("web-research", "source-finder", "browser-operator", "live-info-operator", "toolbelt-readiness"),
        "OMH routes source and browser work, while provider credentials and live retrieval remain external observations.",
        "web_research",
    ),
    CoverageRule(
