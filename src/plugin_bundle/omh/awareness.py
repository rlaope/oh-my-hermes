...
GENERIC_TOOL_CHECKPOINT_ROUTES = (
    ...
    },
    {
        ...
        "preferred_workflows": ("connector-operator", "toolbelt-readiness", "gateway-intent-card", "harness-session-inventory"),
    ...
    },
    {
        ...
        "preferred_workflows": ("live-info-operator", "toolbelt-readiness", "web-research", "connector-operator"),
