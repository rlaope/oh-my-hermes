...
STANDALONE_CAPABILITY_FAMILIES = (
    ...
    },
    {
        ...
        "use_for": "Decks, PDFs, spreadsheets, reports, websites, posters, image cards, and shareable packages.",
        "primary_workflows": ("design-quality-gate", "materials-package", "report-package", "deliverable-package", "img-summary"),
