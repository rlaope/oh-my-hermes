...
PARITY_CAPABILITIES: tuple[ParityCapability, ...] = (
    ...
    ParityCapability(
        ...
        status="available",
        evidence=("src/hud/__init__.py", "src/plugin_bundle/omh/tools/hud_tool.py", "src/wrapper/sessions.py", "src/runtime/artifacts.py"),
    ...
    ParityCapability(
        ...
        status="available",
        evidence=("src/mcp_bridge/__init__.py", "src/commands/mcp.py", "src/probe/__init__.py", "tests/test_mcp_bridge.py"),
    ...
    ParityCapability(
        ...
        status="available",
        evidence=("src/commands/setup.py", "src/doctor/__init__.py", "src/release/__init__.py", "install.sh"),
