...
_DEFINITIONS = [
    ...
    SkillDefinition(
        "goal-experiment",
        "Native goal experiment: shape an ULW loop contract, require explicit Hermes activation, and compare observed results before changing the loop default.",
        (
            "goal experiment",
            "goal-experiment",
            "ulw-goal-experiment",
            "$ulw-goal-experiment",
            "compare ulw loop and native goal",
            "native goal benchmark",
            "goal completion contract experiment",
            "목표 실험",
            "ulw loop와 goal 비교",
            "네이티브 goal 비교",
        ),
        ...
        aliases=("ulw-goal-experiment",),
        category="goal-loop",
        phase="native-goal-experiment",
        hermes_role="planner",
        delegation_boundary="retained-catalog-intent",
        handoff_policy="Keep goal shaping and evidence policy in Hermes/OMH, return prepared native /goal slash text with requires_user_activation, and treat live Hermes activation and continuation as observed only after the host reports evidence.",
        required_inputs=(
            "objective",
            "outcome",
            "verification",
        ...
        why_this_exists="`goal-experiment` exists to test whether ulw-loop goal shaping plus Hermes native /goal continuation improves real outcomes without reversing retired skill contracts or turning prepared slash text into hidden execution.",
        do_not_use_when=(
        ...
        good_example=SkillExample(
            ...
            expected="Prepare the native /goal contract, keep activation explicit, collect paired observed scores, and evaluate the absorption gate without changing the default early.",
        ...
        bad_example=SkillExample(
            ...
            expected="Use the durable checkpoint capability instead of starting a native-goal comparison experiment.",
