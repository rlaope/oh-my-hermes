...
_FEATURE_SURFACE_SKILLS = (
    ...
    _feature_surface_skill(
        ...
        "Hermes media input workflow: scope audio, video, YouTube, meeting recording, transcript, timestamp, and clip-summary requests with source, permission, extraction, transcription, and hallucination gates.",
        (
            "media-input-operator",
            "media input operator",
            "media input",
        ...
        boundary="A media input card is not media access, file upload, download, transcript extraction, speech-to-text output, timestamp accuracy, copyright clearance, source retrieval, or summary correctness evidence unless observed media-result evidence records it.",
...
_SURFACE_EXPOSURES = (
    ...
    SurfaceExposure(
        ...
        True,
        "primary_workflow_skill",
        "Use as an installed Hermes workflow skill when users ask to prepare or supervise audio/video transcription, YouTube/video summaries, meeting recordings, timestamps, or clip summaries without claiming media access or transcript evidence.",
    ),
    SurfaceExposure(
        "data-analysis",
        "workflow_skill",
...
_FEATURE_SURFACE_HARNESSES = (
    ...
    _feature_surface_harness(
        ...
        "Use for meeting recordings, audio transcription, YouTube/video summaries, podcast/webinar summaries, timestamped notes, or clip summaries.",
        ("media type", "source location", "permission boundary", "transcript availability", "requested output and stop condition"),
        (
            "media_input_task_card/v1",
            "media_source_scope/v1",
            "transcript_boundary/v1",
        ...
        overclaim_guard="A media input card is not media access, download, transcript extraction, speech-to-text output, timestamp accuracy, copyright clearance, or media-summary correctness evidence.",
    ),
    _feature_surface_harness(
        "data-analysis",
