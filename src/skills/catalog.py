...
_FEATURE_SURFACE_SKILLS = (
    ...
    _feature_surface_skill(
        "data-analysis",
        "Hermes data analysis workflow: scope supplied CSV, JSON, log, table, or metric-like data analysis with schema, method, and hallucination guards.",
        (
            "data-analysis",
            "data analysis",
            "dataset analysis",
        ...
        boundary="A data analysis card is not file extraction, query execution, chart generation, statistical proof, data correctness, or hallucination-safe numeric evidence unless observed data and method evidence records it.",
...
_FEATURE_SURFACE_HARNESSES = (
    ...
    _feature_surface_harness(
        ...
        "Use when Hermes should prepare or supervise data summary, anomaly, trend, segment, schema, or log-pattern analysis without unsupported numeric claims.",
        ("dataset source or sample", "row/record scope", "columns or schema", "analysis question", "method and stop condition"),
        (
            "data_analysis_task_card/v1",
            "dataset_scope/v1",
            "analysis_method_plan/v1",
        ...
        overclaim_guard="A data analysis card is not file extraction, query execution, chart generation, statistical proof, data correctness, or hallucination-safe numeric evidence.",
    ),
    _feature_surface_harness(
        "toolbelt-readiness",
