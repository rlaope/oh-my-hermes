...
_FEATURE_SURFACE_SKILLS = (
    ...
    _feature_surface_skill(
        "workflow-learning",
        "Hermes workflow learning workflow: turn a completed or attempted workflow into a metadata-only trace, eval, improvement candidate, non-applying patch proposal, regression case, readiness audit, repairable learning index, and redacted review export.",
        (
            "workflow-learning",
            "workflow learning",
            "learning trace",
