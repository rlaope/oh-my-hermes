...
_DEFINITIONS = [
    ...
    SkillDefinition(
        "loop",
        "Hermes Loop workflow: loopability assessment, goal interview, research, planning, runtime ticks, verification tiers, handoff, feedback, and resume cycles.",
        (
            "loop",
            "./loop",
            "$loop",
...
_FEATURE_SURFACE_SKILLS = (
    ...
    _feature_surface_skill(
        "workflow-learning",
        "Hermes workflow learning workflow: turn a completed or attempted workflow into a metadata-only trace, eval, improvement candidate, regression case, readiness audit, repairable learning index, and redacted review export.",
        (
            "workflow-learning",
            "workflow learning",
            "learning trace",
...
_HARNESSES = [
    ...
    HarnessDefinition(
        ...
        "Use when a direct loop invocation or explicit long-horizon goal needs to decide whether it is too small, too large, or truly loopable before repeated cycles over automation, worktree, skill, connector, subagent, and verification building blocks.",
...
_FEATURE_SURFACE_HARNESSES = (
    ...
    _feature_surface_harness(
        ...
        "Use after chat routing, wrapper sessions, runtime runs, or manual feedback should improve future workflow behavior without hidden self-modification, when local learning readiness needs audit, when the local learning index needs check/rebuild, or when a reviewer needs a metadata-only learning bundle.",
