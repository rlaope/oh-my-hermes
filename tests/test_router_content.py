...
class RouterContentTests(unittest.TestCase):
    ...
    def test_first_release_trust_surfaces_are_present(self) -> None:
        ...
        self.assertIn("One chat, five work architectures", profile_map)
        self.assertIn("Profiles describe role interaction patterns around a request.", profile_map)
        self.assertIn("Solo operator", profile_map)
        self.assertIn("Research ops", profile_map)
        self.assertIn("Product ops", profile_map)
        self.assertIn("Coding runtime", profile_map)
        self.assertIn("For PM, CTO, Dev, QA,", profile_map)
        self.assertIn("Security, and Ops lanes.", profile_map)
        self.assertIn("Evidence boundary", profile_map)
