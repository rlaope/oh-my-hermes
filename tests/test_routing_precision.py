...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 52)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 52)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 93)
        self.assertEqual(payload["summary"]["total_passing_count"], 93)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("Interventions: 52/52 expected workflow cases passing", stdout)
