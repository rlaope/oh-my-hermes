...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 397)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 397)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("243/243 negative-control cases passing", stdout)
        self.assertIn("Interventions: 397/397 expected workflow cases passing", stdout)
