...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 13)
        self.assertEqual(payload["summary"]["passing_count"], 13)
        self.assertEqual(payload["summary"]["negative_case_count"], 13)
        self.assertEqual(payload["summary"]["negative_passing_count"], 13)
        self.assertEqual(payload["summary"]["direct_answer_count"], 11)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 26)
        self.assertEqual(payload["summary"]["total_passing_count"], 26)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("13/13 negative-control cases passing", stdout)
