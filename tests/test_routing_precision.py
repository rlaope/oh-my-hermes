...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["negative_case_count"], 8)
        self.assertEqual(payload["summary"]["negative_passing_count"], 8)
        self.assertEqual(payload["summary"]["direct_answer_count"], 6)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 21)
        self.assertEqual(payload["summary"]["total_passing_count"], 21)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("8/8 negative-control cases passing", stdout)
