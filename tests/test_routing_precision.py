...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 174)
        self.assertEqual(payload["summary"]["passing_count"], 174)
        self.assertEqual(payload["summary"]["negative_case_count"], 174)
        self.assertEqual(payload["summary"]["negative_passing_count"], 174)
        self.assertEqual(payload["summary"]["direct_answer_count"], 113)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 312)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 312)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 486)
        self.assertEqual(payload["summary"]["total_passing_count"], 486)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("174/174 negative-control cases passing", stdout)
        self.assertIn("Interventions: 312/312 expected workflow cases passing", stdout)
