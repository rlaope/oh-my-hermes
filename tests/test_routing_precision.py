...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 9)
        self.assertEqual(payload["summary"]["negative_case_count"], 9)
        self.assertEqual(payload["summary"]["negative_passing_count"], 9)
        self.assertEqual(payload["summary"]["direct_answer_count"], 7)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 22)
        self.assertEqual(payload["summary"]["total_passing_count"], 22)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("9/9 negative-control cases passing", stdout)
