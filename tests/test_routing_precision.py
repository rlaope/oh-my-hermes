...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 402)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 402)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("246/246 negative-control cases passing", stdout)
        self.assertIn("Interventions: 402/402 expected workflow cases passing", stdout)
