...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 28)
        self.assertEqual(payload["summary"]["passing_count"], 28)
        self.assertEqual(payload["summary"]["negative_case_count"], 28)
        self.assertEqual(payload["summary"]["negative_passing_count"], 28)
        self.assertEqual(payload["summary"]["direct_answer_count"], 26)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 41)
        self.assertEqual(payload["summary"]["total_passing_count"], 41)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("28/28 negative-control cases passing", stdout)
