...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 38)
        self.assertEqual(payload["summary"]["passing_count"], 38)
        self.assertEqual(payload["summary"]["negative_case_count"], 38)
        self.assertEqual(payload["summary"]["negative_passing_count"], 38)
        self.assertEqual(payload["summary"]["direct_answer_count"], 36)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 51)
        self.assertEqual(payload["summary"]["total_passing_count"], 51)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("38/38 negative-control cases passing", stdout)
