...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["grounded_score_scenarios"], 36)
        ...
        self.assertEqual(payload["summary"]["route_hint_cases"], 61)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 61)
