...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["chat_card_cases"], 84)
        self.assertEqual(payload["summary"]["chat_card_generic_ack_count"], 0)
        self.assertEqual(payload["summary"]["route_hint_cases"], 204)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 204)
        self.assertEqual(payload["summary"]["route_hint_missing_count"], 0)
        self.assertEqual(payload["summary"]["route_hint_mismatch_count"], 0)
        self.assertEqual(payload["summary"]["context_brief_cases"], 11)
        self.assertEqual(payload["summary"]["context_brief_passing_count"], 11)
        # Includes the measured omh-docs and github-issue-intake cases.
        self.assertEqual(payload["summary"]["routing_precision_cases"], 171)
        self.assertEqual(payload["summary"]["routing_precision_passing_count"], 171)
        ...
        self.assertEqual(payload["summary"]["routing_precision_intervention_cases"], 309)
        self.assertEqual(payload["summary"]["routing_precision_intervention_passing_count"], 309)
