...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["grounded_score_scenarios"], 47)
        ...
        self.assertEqual(payload["summary"]["route_hint_cases"], 112)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 112)
        ...
        self.assertEqual(payload["summary"]["routing_precision_cases"], 39)
        self.assertEqual(payload["summary"]["routing_precision_passing_count"], 39)
        ...
        self.assertEqual(payload["summary"]["routing_precision_intervention_cases"], 35)
        self.assertEqual(payload["summary"]["routing_precision_intervention_passing_count"], 35)
