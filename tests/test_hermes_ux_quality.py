...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["grounded_score_scenarios"], 30)
        ...
        self.assertEqual(payload["summary"]["route_hint_cases"], 55)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 55)
