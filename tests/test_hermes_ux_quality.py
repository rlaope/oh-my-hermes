...
class HermesUxQualityTests(unittest.TestCase):
    def test_hermes_ux_quality_rolls_up_user_visible_contracts(self) -> None:
        ...
        self.assertEqual(payload["summary"]["route_hint_cases"], 144)
        self.assertEqual(payload["summary"]["route_hint_aligned_count"], 144)
        ...
        self.assertEqual(payload["summary"]["routing_precision_cases"], 43)
        self.assertEqual(payload["summary"]["routing_precision_passing_count"], 43)
