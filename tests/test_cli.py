...
class CliTests(unittest.TestCase):
    ...
    def test_release_product_readiness_cli_summarizes_product_story(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn("101/101 route hints aligned", gates["route_hint_alignment"]["summary"])
            ...
            self.assertIn("24/24 interventions", gates["routing_precision"]["summary"])
    ...
    def test_release_evidence_bundle_cli_packages_optional_write_artifact(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn(
                "Routing precision: 39/39 negative controls, 24/24 interventions "
            ...
            self.assertEqual(payload["summary"]["route_hint_alignment_aligned"], 101)
            ...
            self.assertEqual(payload["summary"]["routing_precision_intervention_passing"], 24)
            self.assertEqual(payload["summary"]["routing_precision_intervention_total"], 24)
    ...
    def test_demo_route_hint_alignment_keeps_router_and_awareness_hints_in_sync(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 101)
        self.assertEqual(payload["summary"]["hinted_count"], 101)
        self.assertEqual(payload["summary"]["aligned_count"], 101)
        ...
        self.assertEqual(explicit_payload["summary"]["case_count"], 101)
    ...
    def test_demo_route_hint_alignment_summary_is_human_readable(self) -> None:
        ...
        self.assertIn("Result: 101/101 route hints aligned (all passing)", stdout)
        self.assertIn("Hints present: 101/101; missing hints: 0; mismatches: 0", stdout)
        self.assertIn(
