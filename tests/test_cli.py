...
"""
    ...
    def test_release_product_readiness_cli_summarizes_product_story(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn("241/241 negative-control cases", gates["routing_precision"]["summary"])
            self.assertIn("393/393 interventions", gates["routing_precision"]["summary"])
    ...
    def test_release_evidence_bundle_cli_packages_optional_write_artifact(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn(
                "Routing precision: 241/241 negative controls, 393/393 interventions "
            ...
            self.assertEqual(payload["summary"]["routing_precision_intervention_passing"], 393)
            self.assertEqual(payload["summary"]["routing_precision_intervention_total"], 393)
