...
"""
    ...
    def test_release_product_readiness_cli_summarizes_product_story(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn("242/242 negative-control cases", gates["routing_precision"]["summary"])
            self.assertIn("395/395 interventions", gates["routing_precision"]["summary"])
    ...
    def test_release_evidence_bundle_cli_packages_optional_write_artifact(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn(
                "Routing precision: 242/242 negative controls, 395/395 interventions "
            ...
            self.assertEqual(payload["summary"]["routing_precision_intervention_passing"], 395)
            self.assertEqual(payload["summary"]["routing_precision_intervention_total"], 395)
