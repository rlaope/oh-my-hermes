...
class CliTests(unittest.TestCase):
    ...
    def test_release_product_readiness_cli_summarizes_product_story(self) -> None:
        ...
        self.assertIn("38/38 negative-control cases", gates["routing_precision"]["summary"])
    ...
    def test_release_evidence_bundle_cli_packages_optional_write_artifact(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn(
                "Routing precision: 38/38 negative controls, 13/13 interventions "
            ...
            self.assertEqual(payload["summary"]["routing_precision_passing"], 38)
            self.assertEqual(payload["summary"]["routing_precision_total"], 38)
