...
class CliTests(unittest.TestCase):
    ...
    def test_release_product_readiness_cli_summarizes_product_story(self) -> None:
        ...
        self.assertIn("21/21 negative-control cases", gates["routing_precision"]["summary"])
    ...
    def test_release_evidence_bundle_cli_packages_optional_write_artifact(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn(
                "Routing precision: 21/21 negative controls, 13/13 interventions "
            ...
            self.assertEqual(payload["summary"]["grounded_score_perfect"], 28)
            ...
            self.assertEqual(payload["summary"]["routing_precision_passing"], 21)
            self.assertEqual(payload["summary"]["routing_precision_total"], 21)
