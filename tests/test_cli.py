...
"""
    ...
    def test_release_product_readiness_cli_summarizes_product_story(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn("239/239 negative-control cases", gates["routing_precision"]["summary"])
            self.assertIn("391/391 interventions", gates["routing_precision"]["summary"])
    ...
    def test_release_evidence_bundle_cli_packages_optional_write_artifact(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn(
                "Routing precision: 239/239 negative controls, 391/391 interventions "
            ...
            self.assertEqual(payload["summary"]["routing_precision_intervention_passing"], 391)
            self.assertEqual(payload["summary"]["routing_precision_intervention_total"], 391)
