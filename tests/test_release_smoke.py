...
class ReleaseSmokeTests(unittest.TestCase):
    def test_release_readiness_checklist_is_plan_only_and_names_required_gates(self) -> None:
        ...
        self.assertIn("deterministic local routing, card, hint, context, precision, localized-copy, and fast-path contracts", items["hermes_ux_quality"]["proof_boundary"])
    ...
    def test_release_evidence_bundle_packages_and_writes_local_evidence(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertEqual(payload["summary"]["route_hint_alignment_total"], 144)
